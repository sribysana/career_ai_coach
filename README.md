...
- **Plans drift; this notices.** You get warned before you fall behind, not after, and the coach diagnoses *why* progress is slow (wrong resource, unrealistic time budget, fatigue, a real knowledge gap) rather than just rescheduling.
